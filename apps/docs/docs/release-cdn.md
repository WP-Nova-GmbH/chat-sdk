...
Docs selector entries describe the public integration contract, not every npm patch. The `v1.1` docs apply to `@wp-nova/chat-sdk@1.1.x`, `@wp-nova/chat-sdk-react@1.1.x`, and `@wp-nova/chat-sdk-angular@1.1.x`.
