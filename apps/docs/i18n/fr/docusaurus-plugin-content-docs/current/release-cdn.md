...
Les entrées du sélecteur de documentation décrivent le contrat d’intégration public, pas chaque patch npm. La documentation `v1.1` s’applique à `@wp-nova/chat-sdk@1.1.x`, `@wp-nova/chat-sdk-react@1.1.x` et `@wp-nova/chat-sdk-angular@1.1.x`.
