...
Einträge im Dokumentationswähler beschreiben den öffentlichen Integrationsvertrag, nicht jeden npm-Patch. Die `v1.1`-Dokumentation gilt für `@wp-nova/chat-sdk@1.1.x`, `@wp-nova/chat-sdk-react@1.1.x` und `@wp-nova/chat-sdk-angular@1.1.x`.
